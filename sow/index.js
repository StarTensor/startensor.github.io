window.onload = function() {
    ...
    window.document.getElementById("rb3").src =  src="https://api.mcstatus.io/v2/widget/java/nbc.rainplay.cn:25970?dark=true&rounded=true";
...
function rt11() {
    if(lDisplay === false) {
        ...
        window.document.getElementById("rb3").width = "min(384px, calc(100vw - 192px))";
    } else {
        lDisplay = false;
        window.document.getElementById("l").style.display = "none";
        window.document.getElementById("r").style.width = "100vw";
